...
function _rowHtml(citySlug, props, crossDay) {
  ...
  const shareBtn = native
    ? `<span class="sidebar-detail-share" role="button" tabindex="0" data-event-id="${_esc(eventId)}" aria-label="Share event"><svg class="share-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg> Share</span>`
    : "";
